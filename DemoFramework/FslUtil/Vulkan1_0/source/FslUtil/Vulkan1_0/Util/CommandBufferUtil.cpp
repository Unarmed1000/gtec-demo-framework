...
namespace Fsl::Vulkan::CommandBufferUtil
{
  ...
  void SetImageLayout(const VkCommandBuffer cmdBuffer, const VkImage image, const VkImageAspectFlags aspectMask, const VkImageLayout oldImageLayout,
                      const VkImageLayout newImageLayout, const VkImageSubresourceRange& subresourceRange, const VkPipelineStageFlags srcStageMask,
  ...
  void SetImageLayout(const VkCommandBuffer cmdBuffer, const VkImage image, const VkImageAspectFlags aspectMask, const VkImageLayout oldImageLayout,
                      const VkImageLayout newImageLayout, const VkPipelineStageFlags srcStageMask, const VkPipelineStageFlags dstStageMask)
  {
